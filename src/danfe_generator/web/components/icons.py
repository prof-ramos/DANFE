...
def get_svg(
    ...
    Args:
        ...
        margin_right: Margem direita (ex: "8px"). Se None, não aplica estilo.
    """
    icons = {
    ...
    style_attr = ""
    if margin_right:
        style_attr = f'style="margin-right: {margin_right};"'
...
def render_icon_text(
    ...
    class_name = "icon-text-wrapper"
    if header:
        class_name += " icon-text-header"
